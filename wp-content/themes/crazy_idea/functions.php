<?php
/**
 * Crazy Idea functions and definitions
 *
 ...
 */
function crazy_idea_setup() {
	/*
		* Make theme available for translation.
		* Translations can be filed in the /languages/ directory.
		* If you're building a theme based on Crazy Idea, use a find and replace
		* to change 'crazy_idea' to the name of your theme in all the template files.
		*/
	load_theme_textdomain( 'crazy_idea', get_template_directory() . '/languages' );
	...
	add_theme_support(
		'custom-background',
		apply_filters(
			'crazy_idea_custom_background_args',
			array(
...
add_action( 'after_setup_theme', 'crazy_idea_setup' );
 ...
 */
function crazy_idea_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'crazy_idea_content_width', 640 );
}
add_action( 'after_setup_theme', 'crazy_idea_content_width', 0 );
 ...
 */
function crazy_idea_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'crazy_idea' ),
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'crazy_idea' ),
...
add_action( 'widgets_init', 'crazy_idea_widgets_init' );
...
add_action( 'wp_enqueue_scripts', 'crazy_idea_scripts' );
